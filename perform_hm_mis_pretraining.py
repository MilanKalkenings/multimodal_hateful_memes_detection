...
# init: cross_mis: "../final_runs/pretraining/cross_pretraining/seed1/1_token_roi_kg/model_epoch_15.pkl", #"../final_runs/random_init.pkl"
# init: cross_hm: "../final_runs/pretraining/cross_pretraining/seed1/1_token_sentiment_kg_vit/model_epoch_8.pkl", #"../final_runs/random_init.pkl"
...
for seed in [1, 2, 3]:  # standard: 1,2,3 (if not only one version run, else only "1")
